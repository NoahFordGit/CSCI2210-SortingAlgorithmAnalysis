...
class QuickSortBenchmark:
    ...
    def run_benchmarks(self):
        ...
        print('Completed sorted 1000 benchmark')
    ...
    def plot_results(self):
        labels = ['sorted 1000', 'random 1000', 'reverse 1000','random 100,000']
        ...
        plt.title('Quick Sort Benchmark Results')
